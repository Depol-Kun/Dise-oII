        ...
        <div class="table table-striped table-hover">
            <table class="table table-striped table-bordered align-middle">
                ...
                <tr>
                    ...
                    <th>Direccion</th>
                    <th>Admin</th>
                    <th colspan="2"><a href="nuevo.php" class="btn btn-outline-primary">Insertar</a>
                    </th>
                    <th><a href="api.php" class="btn btn-outline-info btn-sm">JSON</a></th>
                </tr>
                ...
                <tr>
                    ...
                    <th><a href="api.php?id=<?php echo $fila['id']; ?>" class="btn btn-outline-info btn-sm" target="_blank">JSON</a></th>
                </tr>
                <?php 
                } 
                ?>
